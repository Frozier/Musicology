...
compmus_long_distance(
  ...
  geom_tile() +
  coord_equal() +
  labs(x = "Science & Faith", y = "Wasted Nights", title = "Dynamic Time Warping between two songs similar in energy and Danceability") +
  theme_minimal() +
  scale_fill_viridis_c(guide = NULL)
```

### Chromogram of We'll Be Alright
...
***
Cepstrogram shows something very interesting. There is nearly no similarity between any of the parts within the song!
